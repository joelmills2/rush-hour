...
def starting_board(grid):
    ...
    E.add_constraint(grid[0][2]['V2'])
    E.add_constraint(grid[0][3]['H3'])
    E.add_constraint(grid[0][4]['H3'])
    E.add_constraint(grid[0][5]['H3'])
    E.add_constraint(grid[1][0]['V2'])
    E.add_constraint(grid[1][1]['V2'])
    E.add_constraint(grid[1][2]['V2'])
    E.add_constraint(grid[1][3]['E'])
    E.add_constraint(grid[1][4]['V2'])
    E.add_constraint(grid[1][5]['V2'])
    E.add_constraint(grid[2][0]['V2'])
    E.add_constraint(grid[2][1]['V2'])
    E.add_constraint(grid[2][2]['Red'])
    E.add_constraint(grid[2][3]['Red'])
    E.add_constraint(grid[2][4]['V2'])
    E.add_constraint(grid[2][5]['V2'])
    E.add_constraint(grid[3][0]['V2'])
    E.add_constraint(grid[3][1]['H2'])
    E.add_constraint(grid[3][2]['H2'])
    E.add_constraint(grid[3][3]['H2'])
    E.add_constraint(grid[3][4]['H2'])
    E.add_constraint(grid[3][5]['V3'])
    E.add_constraint(grid[4][0]['V2'])
    E.add_constraint(grid[4][1]['E'])
    E.add_constraint(grid[4][2]['E'])
    E.add_constraint(grid[4][3]['E'])
    E.add_constraint(grid[4][4]['E'])
    E.add_constraint(grid[4][5]['V3'])
    E.add_constraint(grid[5][0]['H2'])
    E.add_constraint(grid[5][1]['H2'])
    E.add_constraint(grid[5][2]['H3'])
